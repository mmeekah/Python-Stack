...
class Bear(Animal):
    def __init__(self, name, age, health_level, happiness_level):
        ...
        self.skill="Cold"
    def display_info(self):
        print(f"{self.name} is at {self.health_level} health level and at {self.happiness_level} happpiness level! My special skill is {self.skill}.")
        return self
    def feed_animal(self):
        super().feed_animal()
        return self
zoo_one = Zoo("Alim's Zoo")
